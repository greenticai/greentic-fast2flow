//! Component descriptor for the router.
...
pub fn describe() -> ComponentDescribe {
    ComponentDescribe {
        info: info(),
        provided_capabilities: vec!["fast2flow:router".to_string()],
        required_capabilities: vec!["fast2flow:matcher".to_string()],
